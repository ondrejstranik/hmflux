...
class EmitterImageProfileViewer():
    ''' main class for viewing emitter Images'''
    #TODO: finish the class

    def __init__(self,emitterImage:EmitterImageProfile=None, **kwargs):
        ...
        EmitterImageProfileViewer._setWidget(self)
    ...
    def setEmitterImage(self,emitterImage:EmitterImageProfile):
